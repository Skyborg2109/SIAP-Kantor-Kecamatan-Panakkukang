...
>
    ...
    <div
        x-show="show"
        class="bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-100 transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto relative z-10 my-8"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\laragon\www\SIAP-Kantor-Camat-Panakkukang\resources\views/components/modal.blade.php ENDPATH**/ ?>