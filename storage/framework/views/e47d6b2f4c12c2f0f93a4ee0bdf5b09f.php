    ...
    <header class="flex items-center gap-3 pb-4 border-b border-rose-100">
        ...
        <div>
            <h2 class="text-base font-bold text-slate-900">
                <?php echo e(__('Hapus Akun Pengguna')); ?>

            </h2>
            <p class="text-xs text-slate-500 mt-0.5">
                <?php echo e(__('Setelah akun dihapus, seluruh sumber daya dan data terkait akan dihapus secara permanen.')); ?>
...
<?php echo e(__('Hapus Akun Saya')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6 sm:p-8">
            ...
            <p class="mt-2 text-xs sm:text-sm text-slate-500 leading-relaxed">
                <?php echo e(__('Tindakan ini tidak dapat dibatalkan. Masukkan kata sandi Anda untuk mengonfirmasi penghapusan permanen akun ini dari sistem.')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'password','value' => ''.e(__('Kata Sandi Konfirmasi')).'','class' => 'sr-only']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'password','value' => ''.e(__('Kata Sandi Konfirmasi')).'','class' => 'sr-only']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password','name' => 'password','type' => 'password','class' => 'block w-full sm:w-3/4','placeholder' => ''.e(__('Masukkan Kata Sandi')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','name' => 'password','type' => 'password','class' => 'block w-full sm:w-3/4','placeholder' => ''.e(__('Masukkan Kata Sandi')).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\laragon\www\SIAP-Kantor-Camat-Panakkukang\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>